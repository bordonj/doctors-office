...
public ActionResult Details(int id)
{
    var thisPatient = _db.Patients
        ...
        .ThenInclude(join => join.Doctor) // to include the actual Doctor objects themselves
        // this loads the Doctor of each DoctorPatient 
        // remember, DoctorPatient is simply a reference to a relationship
